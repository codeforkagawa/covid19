...
## コミュニケーションへの参加方法
* Code for Kagawa の Slack アカウントを持っていない場合、[こちらから登録](https://join.slack.com/t/stopcovid19kagawa/shared_invite/zt-d7n8dw03-dcXS~whdHp87LhRMcGO81A)してください
* `#香川県版新型コロナウイルス対策サイト` チャンネルにご参加ください。
...
* 本番サイト https://kagawa.stopcovid19.jp/
